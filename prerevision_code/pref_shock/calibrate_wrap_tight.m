...
guess = [1.2959    0.5367    1.5556    0.7254    1.5138    0.6952    0.6435    0.5857    0.1053];
...
new_cal = patternsearch(ObjectiveFunction,(cal),[],[],[],[],log(lower_bound),log(upper_bound),[],options_pa) 
