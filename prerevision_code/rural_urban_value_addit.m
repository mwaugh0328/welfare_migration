...
%     converg_criteria = norm(log(-1.*v_old_rural_not) - log(-1.*v_prime_rural_not),Inf) && ...
%        norm(log(-1.*v_old_rural_exp) - log(-1.*v_prime_rural_exp),Inf) && ...     
%        norm(log(-1.*v_old_urban_new) - log(-1.*v_prime_urban_new),Inf) && ...
%        norm(log(-1.*v_old_urban_old) - log(-1.*v_prime_urban_old),Inf);
   
    converg_criteria = norm((v_old_rural_not) - (v_prime_rural_not),Inf) && ...
       norm((v_old_rural_exp) - (v_prime_rural_exp),Inf) && ...     
       norm((v_old_urban_new) - (v_prime_urban_new),Inf) && ...
       norm((v_old_urban_old) - (v_prime_urban_old),Inf) < tol;
