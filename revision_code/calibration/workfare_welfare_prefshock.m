function [assets, move, cons_eqiv] = workfare_welfare_prefshock(params, perm_types, shocks, tmat, value_funs)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% From the old code. I belive I picked the .75 so the same ammount of money
% is always spent across unconditional, migration, and this. Text I think
% explains. But this number may need to be adjsuted
