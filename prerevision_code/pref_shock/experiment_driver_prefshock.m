function [sim_expr, sim_cntr] = experiment_driver_prefshock(assets, move, assets_temp,...
    move_temp, cons_eqiv, params, perm_type, trans_shocks, monga_index,...
...
for xxx = 1:Nsims
    ...
    [panel_expr] = simmulate_experiment_prefshock(assets, move, assets_temp, move_temp, cons_eqiv, params, perm_type,...
