...
\end{eqnarray*}
where the sum across $j$'s are the different choices. Another important feature to note with this specification is that the expected value function (with respect to the preference shocks) is
\begin{eqnarray*}
\small
