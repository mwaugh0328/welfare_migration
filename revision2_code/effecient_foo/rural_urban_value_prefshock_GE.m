...
for zzz = 1:n_shocks
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    consumption = net_assets + labor_income_tax(z_rural.*shocks_rural(zzz), params.tax,0) - abar;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    consumption = net_assets + labor_income_tax(z_rural.*shocks_rural(zzz), params.tax,0) - mtest_move - abar;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    consumption = net_assets + labor_income_tax(z_urban.*shocks_urban(zzz), params.tax,1) - abar;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    consumption = net_assets + labor_income_tax(z_rural.*shocks_rural(zzz), params.tax,0) - m - abar;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    consumption = net_assets + labor_income_tax(z_urban.*shocks_urban(zzz), params.tax,1) - m - abar;
...
%     pitest = pi_rural_not./pi_denom_rural_not;
%     
%     test_v_prime_rural_not(:,zzz) = sum(pitest.*(sigma_nu_not.*log(1./max(pitest, 10^-25))  + [v_stay_rural_not, v_move_seasn_not, v_move_rural_not]),2);
...
%     pitest = pi_rural_exp./pi_denom_rural_exp;
%     
%     test_v_prime_rural_exp(:,zzz) = sum(pitest.*(sigma_nu_not.*log(1./max(pitest, 10^-25))  + [v_stay_rural_exp, v_move_seasn_exp, v_move_rural_exp]),2);
...
%     pitest = pi_urban_new./pi_denom_urban_new;
%     
%     test_v_prime_urban_new(:,zzz) = sum(pitest.*(sigma_nu_not.*log(1./max(pitest, 10^-25))  + [v_stay_urban_new, v_move_urban_new]),2);
    ...
    pitest = pi_urban_old./pi_denom_urban_old;
    
    test_v_prime_urban_old(:,zzz) = sum(pitest.*(sigma_nu_not.*log(1./max(pitest, 10^-25))  + [v_stay_urban_old, v_move_urban_old]),2);
