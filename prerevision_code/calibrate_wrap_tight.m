...
upper_bound = [1.40, 0.55, 1.60, 0.85, 1.60, 0.65, 0.65, 0.75]; 
lower_bound = [1.00, 0.47, 1.40, 0.50, 1.40, 0.35, 0.35, 0.50]; 
...
% 
% % guess = cal;
% %guess = [1.3563    0.5039    1.4368    0.7510    1.4854    0.5683   0.5683  0.5978];
% 
% new_cal = patternsearch(ObjectiveFunction,guess,[],[],[],[],(lower_bound),(upper_bound),[],options_pa) 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save calibration_gittest new_cal
